# Generated by Django 4.2.11 on 2025-06-09 22:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('movie', 'Movie'), ('tv_show', 'Show')], default='movie', max_length=30, verbose_name='type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('role', models.CharField(choices=[('director', 'Director'), ('actor', 'Actor'), ('writer', 'Writer')], max_length=30, verbose_name='role')),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('film_work', 'person', 'role'), name='film_work_person_role_unique_idx'),
        ),
        migrations.AddConstraint(
